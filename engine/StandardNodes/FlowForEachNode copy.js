...
import { black_80, number_background, object_background } from "../../styles/GlobalColors"


const FlowForEachNode = ({data}) => {
    return(
        <Container
            stack
        ...
        >
            ...
            <Handle type="number"  position={Position.Left} style={ { top:40, left: 5, borderColor: object_background } }>
                <Typo margin="0px 1em" size="6pt" width="50px">Target</Typo>
            </Handle>
...
export default FlowForEachNode